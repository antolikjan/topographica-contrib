...
arguments=(
"A=0,ImageScale=0.35,AFF_lr=0.4,StoCStr=4.0,MUE=0.006,MUI=0.008,SETAE=0.002,SETAI=0.002,default_density=96,LGNStr=4,SEEStr=1.0,SEIStr=0.7,SIEStr=-5.3,SIIStr=-5.7,CEFeedback=0.14,CIFeedback=0.2,SEElr=0.0,SEIlr=0.0,SIElr=0.0,SIIlr=0.0"
...
"A=6,ImageScale=0.35,AFF_lr=0.4,StoCStr=4.0,MUE=0.006,MUI=0.008,SETAE=0.002,SETAI=0.002,default_density=96,LGNStr=4,SEEStr=1.0,SEIStr=0.7,SIEStr=-5.3,SIIStr=-5.7,CEFeedback=0.14,CIFeedback=0.2,SEElr=0.1,SEIlr=0.1,SIElr=0.1,SIIlr=0.1,AHRule=True"
)
 

args='import matplotlib; matplotlib.use("Agg"); from topo.command import run_batch ; import contrib.jaanalysis; run_batch("./topographica/contrib/CCLISSOM_push_pull.ty",analysis_fn=contrib.jaanalysis.push_pull_analysis_function,output_directory="/exports/home/s0570140/go_new/RESULTS/CCLISSOMPP32/",times=[5005,10005,10007],snapshot=False,dirname_prefix='
